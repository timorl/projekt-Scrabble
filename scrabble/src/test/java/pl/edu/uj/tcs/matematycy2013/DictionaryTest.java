...
public class DictionaryTest {
    ...
    public void testBasic() throws IOException {
        ...
        InputStream in= Thread.currentThread().getContextClassLoader().getResourceAsStream("words-pl.txt");
        Dictionary d = new Dictionary(in,alphabet);
    ...
    public void englishDictionaryTest() throws IOException {
        ...
        InputStream in= Thread.currentThread().getContextClassLoader().getResourceAsStream("words-en.txt");
        Dictionary d = new Dictionary(in,alphabet);
